...
using Mavanmanen.StreamDeckSharp.Events;
using Mavanmanen.StreamDeckSharp.Messages;
...
namespace Mavanmanen.StreamDeckSharp
{
    public class StreamDeckClient
    {
        ...
        public StreamDeckClient(string[] args) : this(StreamDeckClientArguments.ParseFromArgs(args)) { }

        public StreamDeckClient(StreamDeckClientArguments args)
        {
            _arguments = args;
        }
